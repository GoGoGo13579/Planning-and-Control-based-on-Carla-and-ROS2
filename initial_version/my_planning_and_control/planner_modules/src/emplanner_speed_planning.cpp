...
void EMPlanner::generate_convex_space(const std::vector<TrajectoryPoint>& init_trajectory, const std::vector<double> path_index2s, const std::deque<STPoint>& speed_profile, const std::vector<std::unordered_map<std::string, double>>& dynamic_obs_st_graph, 
...
void EMPlanner::generate_trajectory(const std::vector<STPoint>& final_speed_profile, const std::vector<TrajectoryPoint>& path_trajectory, const std::vector<double>& path_index2s,
                                    const double& planning_start_point_time_stamped ,std::vector<TrajectoryPoint>& trajectory)
{
